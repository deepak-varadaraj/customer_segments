# Machine Learning Basic Nanodegree by Udacity
## Project 2: Creating Customer Segments

### Project Description

This is the 2nd project for the Machine Learning Basic Nanodegree. In this project I apply unsupervised learning techniques on product spending data collected for customers of a wholesale distributor to identify customer segments hidden in the data. 
...
It is highly recommended to install [Anaconda](http://continuum.io/downloads) distribution of Python, which already has the above packages and more included. Make sure that you select the Python 2.7 installer and not the Python 3.x installer. 
